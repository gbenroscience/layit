/* global attrKeys, ListView, ListAdapter, styleSheet */
GridAdapter.prototype = Object.create(ListAdapter.prototype);
GridAdapter.prototype.constructor = GridAdapter;
/**
 *
 ...
 * @constructor
 */
function GridAdapter(list, callback) {
 ...
 */
GridAdapter.prototype.fetchPrototypeCells = function (list, callback) {
    let self = this;
...
GridAdapter.prototype.makeCell = function (adapterView, viewType) {
